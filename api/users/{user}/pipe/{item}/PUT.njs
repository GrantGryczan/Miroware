		...
		if (this.req.body.name !== undefined) {
			if (typeof this.req.body.name === "string") {
				...
				if (this.req.body.name.length < 1) {
					...
					this.done();
					return;
				} else if (!user.exception && !typeDir && (this.req.body.name.toLowerCase().endsWith(".apk") || this.req.body.name.toLowerCase().endsWith(".exe") || this.req.body.name.toLowerCase().endsWith(".msi") || this.req.body.name.toLowerCase().endsWith(".bin") || this.req.body.name.toLowerCase().endsWith(".vbs") || this.req.body.name.toLowerCase().endsWith(".vbe") || this.req.body.name.toLowerCase().endsWith(".ps1") || this.req.body.name.toLowerCase().endsWith(".reg"))) {
					this.value = {
