...
tmux new -d -s pipe ./forever.sh ./pipe.js 0
tmux new -d -s pipe ./forever.sh ./pipe.js 1
tmux new -d -s pipe ./forever.sh ./pipe.js 3
tmux new -d -s pipe ./forever.sh ./pipe.js 4
