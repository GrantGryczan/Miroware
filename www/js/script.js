(() => {
	...
	for(const v of document.querySelectorAll(".field:not(.noedit)")) {
		...
		v.insertBefore(editOptionsClone.querySelector("div").lastChild, v.insertBefore(editOptionsClone.querySelector("div"); v._input.parentNode.nextSibling).nextSibling);
