...
function config {
	...
	tellraw @s [{"text":"Enter","color":"COLOR_3"},{"text":" or ","color":"COLOR_1"},{"text":"click","color":"COLOR_3"},{"text":" on ","color":"COLOR_1"},{"text":"/scoreboard players set #chance conCre.config <percentage>","color":"COLOR_2","clickEvent":{"action":"suggest_command","value":"/scoreboard players set #chance conCre.config "},"hoverEvent":{"action":"show_text","value":[{"text":"Click to write ","color":"COLOR_1"},{"text":"/scoreboard players set #chance conCre.config","color":"COLOR_2"},{"text":".\nEnter the number 0 to 100 after clicking.","color":"COLOR_1"}]}},{"text":" to set the percent chance each creeper will be a confetti creeper. The default is ","color":"COLOR_1"},{"text":"100","color":"COLOR_2","clickEvent":{"action":"run_command","value":"/scoreboard players set #chance conCre.config 100"},"hoverEvent":{"action":"show_text","value":[{"text":"Click to run ","color":"COLOR_1"},{"text":"/scoreboard players set #chance conCre.config 100","color":"COLOR_2"},{"text":".","color":"COLOR_1"}]}},{"text":". If this is not 100, the recommended value is ","color":"COLOR_1"},{"text":"20","color":"COLOR_2","clickEvent":{"action":"run_command","value":"/scoreboard players set #chance conCre.config 20"},"hoverEvent":{"action":"show_text","value":[{"text":"Click to run ","color":"COLOR_1"},{"text":"/scoreboard players set #chance conCre.config 20","color":"COLOR_2"},{"text":".","color":"COLOR_1"}]}},{"text":".","color":"COLOR_1"}]
}
