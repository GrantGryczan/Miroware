...
clock 5t {
	...
	execute as @a[scores={cusNetPor=1}] run {
		...
		execute if score #cryingObsidian cusNetPor.config matches 1 run tellraw @s ["",{"text":">>","color":"gold"}," Nether portal frames ",{"text":"can","color":"green"}," use crying obsidian."]
		execute unless score #cryingObsidian cusNetPor.config matches 1 run tellraw @s ["",{"text":">>","color":"gold"}," Nether portal frames ",{"text":"cannot","color":"red"}," use crying obsidian."]
		tellraw @s {"text":"                                                                                ","color":"dark_gray","strikethrough":true}
...
dir config {
	...
	function enable_crying_obsidian {
		scoreboard players set #cryingObsidian cusNetPor.config 1
		function custom_nether_portals:config
	}
	function disable_crying_obsidian {
