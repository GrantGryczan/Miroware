...
function sufficient_sleeping {
	scoreboard players add #timer mulSle.dummy 1
	execute if score #timer mulSle.dummy matches 100 run function multiplayer_sleep:stop_sleeping
}
function stop_sleeping {
