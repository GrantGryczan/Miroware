...
function config {
	...
	execute if score #display mpSleep.config matches 1 run tellraw @s ["",{"text":"[ ✔ ]","color":"green","clickEvent":{"action":"run_command","value":"/function multiplayer_sleep:config/enable_default_display_hidden"},"hoverEvent":{"action":"show_text","value":["",{"text":"Click to disable ","color":"red"},"Default Display: Boss Bar",{"text":".","color":"red"}]}}," ",{"text":"[ ℹ ]","color":"gray","clickEvent":{"action":"run_command","value":"/trigger mpSleep set 4"},"hoverEvent":{"action":"show_text","value":["",{"text":"Click to preview ","color":"gray"},"Default Display: Boss Bar",{"text":".\nThe boss bar preview's color may not be accurate.","color":"dark_gray"}]}}," Default Display: Boss Bar"]
	execute unless score #display mpSleep.config matches 1 run tellraw @s ["",{"text":"[ ❌ ]","color":"red","clickEvent":{"action":"run_command","value":"/function multiplayer_sleep:config/enable_default_display_boss_bar"},"hoverEvent":{"action":"show_text","value":["",{"text":"Click to enable ","color":"green"},"Default Display: Boss Bar",{"text":".","color":"green"}]}}," ",{"text":"[ ℹ ]","color":"gray","clickEvent":{"action":"run_command","value":"/trigger mpSleep set 4"},"hoverEvent":{"action":"show_text","value":["",{"text":"Click to preview ","color":"gray"},"Default Display: Boss Bar",{"text":".\nThe boss bar preview's color may not be accurate.","color":"dark_gray"}]}}," Default Display: Boss Bar"]
	...
	execute if score #display mpSleep.config matches 3 run tellraw @s ["",{"text":"[ ✔ ]","color":"green","clickEvent":{"action":"run_command","value":"/function multiplayer_sleep:config/enable_default_display_hidden"},"hoverEvent":{"action":"show_text","value":["",{"text":"Click to disable ","color":"red"},"Default Display: Chat",{"text":".","color":"red"},{"text":"\nDefault","color":"dark_gray"}]}}," ",{"text":"[ ℹ ]","color":"gray","clickEvent":{"action":"run_command","value":"/trigger mpSleep set 6"},"hoverEvent":{"action":"show_text","value":["",{"text":"Click to preview ","color":"gray"},"Default Display: Chat",{"text":".","color":"gray"}]}}," Default Display: Chat"]
	execute unless score #display mpSleep.config matches 3 run tellraw @s ["",{"text":"[ ❌ ]","color":"red","clickEvent":{"action":"run_command","value":"/function multiplayer_sleep:config/enable_default_display_chat"},"hoverEvent":{"action":"show_text","value":["",{"text":"Click to enable ","color":"green"},"Default Display: Chat",{"text":".","color":"green"},{"text":"\nDefault","color":"dark_gray"}]}}," ",{"text":"[ ℹ ]","color":"gray","clickEvent":{"action":"run_command","value":"/trigger mpSleep set 6"},"hoverEvent":{"action":"show_text","value":["",{"text":"Click to preview ","color":"gray"},"Default Display: Chat",{"text":".","color":"gray"}]}}," Default Display: Chat"]
	...
	execute if score #alwaysClear mpSleep.config matches 1 run tellraw @s ["",{"text":"[ ✔ ]","color":"green","clickEvent":{"action":"run_command","value":"/function multiplayer_sleep:config/disable_always_clear"},"hoverEvent":{"action":"show_text","value":["",{"text":"Click to disable ","color":"red"},"Always Reset Weather Cycle",{"text":".","color":"red"},{"text":"\nWhen enabled, the weather cycle will reset to clear upon sleeping, whether or not the weather is clear already.","color":"gray"},{"text":"\nWhen sleeping occurs, this may cause rain to briefly appear, and the weather will not rain for a while afterward. This setting is incompatible with gamerule doWeatherCycle false.","color":"red"},{"text":"\nWhen disabled, the weather cycle will only reset to clear upon sleeping if it's already raining, just like in vanilla.","color":"gray"},{"text":"\nDefault: Disabled","color":"dark_gray"}]}}," Always Reset Weather Cycle"]
	execute unless score #alwaysClear mpSleep.config matches 1 run tellraw @s ["",{"text":"[ ❌ ]","color":"red","clickEvent":{"action":"run_command","value":"/function multiplayer_sleep:config/enable_always_clear"},"hoverEvent":{"action":"show_text","value":["",{"text":"Click to enable ","color":"green"},"Always Reset Weather Cycle",{"text":".","color":"green"},{"text":"\nWhen enabled, the weather cycle will reset to clear upon sleeping, whether or not the weather is clear already.","color":"gray"},{"text":"\nWhen sleeping occurs, this may cause rain to briefly appear, and the weather will not rain for a while afterward. This setting is incompatible with gamerule doWeatherCycle false.","color":"red"},{"text":"\nWhen disabled, the weather cycle will only reset to clear upon sleeping if it's already raining, just like in vanilla.","color":"gray"},{"text":"\nDefault: Disabled","color":"dark_gray"}]}}," Always Reset Weather Cycle"]
	tellraw @s {"text":"                                                                                ","color":"dark_gray","strikethrough":true}
