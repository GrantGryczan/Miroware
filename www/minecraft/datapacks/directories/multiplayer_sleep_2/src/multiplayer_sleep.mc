...
function config {
	...
	execute unless score #display mpSleep.config matches 0 run tellraw @s ["",{"text":"[ ❌ ]","color":"red","clickEvent":{"action":"run_command","value":"/function multiplayer_sleep:config/enable_default_display_hidden"},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to enable ","color":"green"},"Default Display: Hidden",{"text":".","color":"green"},{"text":"\nDefault","color":"dark_gray"}]}}," Default Display: Hidden"]
