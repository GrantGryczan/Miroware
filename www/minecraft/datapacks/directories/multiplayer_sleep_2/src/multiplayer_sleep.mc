...
clock 1t {
	...
	execute as @a[scores={mpSleep=1..}] run {
		...
		execute if score @s mpSleep matches 1 run {
			...
			tellraw @s [{"text":"- [ ","color":"dark_aqua"},{"text":"Show Display Options","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger mpSleep set 3"},"hoverEvent":{"action":"show_text","contents":[{"text":"Click to show display options.","color":"dark_aqua"}]}},{"text":" ]","color":"dark_aqua"}]
			tellraw @s [{"text":"- [ ","color":"dark_aqua"},{"text":"List Sleeping Players","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger mpSleep set 2"},"hoverEvent":{"action":"show_text","contents":[{"text":"Click to list sleeping players.","color":"dark_aqua"}]}},{"text":" ]","color":"dark_aqua"}]
		}
		...
		execute if score @s mpSleep matches 3 run {
			name info_3
			tellraw @s [{"text":"[ Display Options ]","color":"gold"},{"text":"\n- Boss Bar: [","color":"dark_aqua"},{"text":"Set","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger mpSleep.config set 1"},"hoverEvent":{"action":"show_text","contents":[{"text":"Click to set ","color":"dark_aqua"},{"text":"Boss Bar","color":"aqua"},{"text":".","color":"dark_aqua"}]}},{"text":"] [","color":"dark_aqua"},{"text":"Preview","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger mpSleep set 4"},"hoverEvent":{"action":"show_text","contents":[{"text":"Click to preview ","color":"dark_aqua"},{"text":"Boss Bar","color":"aqua"},{"text":".","color":"dark_aqua"}]}},{"text":"]\n- Action Bar: [","color":"dark_aqua"},{"text":"Set","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger mpSleep.config set 2"},"hoverEvent":{"action":"show_text","contents":[{"text":"Click to set ","color":"dark_aqua"},{"text":"Action Bar","color":"aqua"},{"text":".","color":"dark_aqua"}]}},{"text":"] [","color":"dark_aqua"},{"text":"Preview","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger mpSleep set 5"},"hoverEvent":{"action":"show_text","contents":[{"text":"Click to preview ","color":"dark_aqua"},{"text":"Action Bar","color":"aqua"},{"text":".","color":"dark_aqua"}]}},{"text":"]\n- Chat: [","color":"dark_aqua"},{"text":"Set","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger mpSleep.config set 3"},"hoverEvent":{"action":"show_text","contents":[{"text":"Click to set ","color":"dark_aqua"},{"text":"Chat","color":"aqua"},{"text":".","color":"dark_aqua"}]}},{"text":"] [","color":"dark_aqua"},{"text":"Preview","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger mpSleep set 6"},"hoverEvent":{"action":"show_text","contents":[{"text":"Click to preview ","color":"dark_aqua"},{"text":"Chat","color":"aqua"},{"text":".","color":"dark_aqua"}]}},{"text":"]\n- [ ","color":"dark_aqua"},{"text":"Reset to Default","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger mpSleep.config set 0"},"hoverEvent":{"action":"show_text","contents":[{"text":"Click to reset.","color":"dark_aqua"}]}},{"text":" ]","color":"dark_aqua"}]
		}
