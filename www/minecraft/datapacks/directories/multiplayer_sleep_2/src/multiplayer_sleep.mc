...
clock 1t {
	...
	execute as @a[scores={mpSleep=1..}] run {
		...
		execute if score @s mpSleep matches 1 run {
			...
			tellraw @s {"text":"                            [Personal Settings]                            ","color":"gray","clickEvent":{"action":"run_command","value":"/trigger mpSleep set 3"},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to show personal settings.","color":"gray"}]}}
			tellraw @s {"text":"                          [List Sleeping Players]                          ","color":"gray","clickEvent":{"action":"run_command","value":"/trigger mpSleep set 2"},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to list sleeping players.","color":"gray"}]}}
			tellraw @a {"text":"                                                                                ","color":"dark_gray","strikethrough":true}
		}
		...
		execute if score @s mpSleep matches 3 run {
			...
			execute if score @s mpSleep.config matches 0.. run {
				...
				execute if score #display mpSleep.config matches 0 run tellraw @s ["",{"text":"[ ❌ ]","color":"red","clickEvent":{"action":"run_command","value":"/trigger mpSleep set 7"},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to enable ","color":"green"},"Display Mode: Default",{"text":".","color":"green"}]}}," Display Mode: Default (Hidden)"]
				execute if score #display mpSleep.config matches 1 run tellraw @s ["",{"text":"[ ❌ ]","color":"red","clickEvent":{"action":"run_command","value":"/trigger mpSleep set 7"},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to enable ","color":"green"},"Display Mode: Default",{"text":".","color":"green"}]}}," Display Mode: Default (Boss Bar)"]
				execute if score #display mpSleep.config matches 2 run tellraw @s ["",{"text":"[ ❌ ]","color":"red","clickEvent":{"action":"run_command","value":"/trigger mpSleep set 7"},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to enable ","color":"green"},"Display Mode: Default",{"text":".","color":"green"}]}}," Display Mode: Default (Action Bar)"]
				execute if score #display mpSleep.config matches 3 run tellraw @s ["",{"text":"[ ❌ ]","color":"red","clickEvent":{"action":"run_command","value":"/trigger mpSleep set 7"},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to enable ","color":"green"},"Display Mode: Default",{"text":".","color":"green"}]}}," Display Mode: Default (Chat)"]
			}
			execute unless score @s mpSleep.config matches 0.. run {
				name trigger/show_enabled_display_mode_default
				execute if score #display mpSleep.config matches 0 run tellraw @s ["",{"text":"[ ✔ ]","color":"green"}," Display Mode: Default (Hidden)"]
				execute if score #display mpSleep.config matches 1 run tellraw @s ["",{"text":"[ ✔ ]","color":"green"}," Display Mode: Default (Boss Bar)"]
				execute if score #display mpSleep.config matches 2 run tellraw @s ["",{"text":"[ ✔ ]","color":"green"}," Display Mode: Default (Action Bar)"]
				execute if score #display mpSleep.config matches 3 run tellraw @s ["",{"text":"[ ✔ ]","color":"green"}," Display Mode: Default (Chat)"]
			}
			execute if score @s mpSleep.config matches 1 run tellraw @s ["",{"text":"[ ✔ ]","color":"green","clickEvent":{"action":"run_command","value":"/trigger mpSleep set 7"},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to disable ","color":"red"},"Display Mode: Boss Bar",{"text":".","color":"red"}]}}," ",{"text":"[ ℹ ]","color":"gray","clickEvent":{"action":"run_command","value":"/trigger mpSleep set 4"},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to preview ","color":"gray"},"Display Mode: Boss Bar",{"text":".\nThe boss bar preview's color may not be accurate.","color":"gray"}]}}," Display Mode: Boss Bar"]
			execute unless score @s mpSleep.config matches 1 run tellraw @s ["",{"text":"[ ❌ ]","color":"red","clickEvent":{"action":"run_command","value":"/trigger mpSleep set 8"},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to enable ","color":"green"},"Display Mode: Boss Bar",{"text":".","color":"green"}]}}," ",{"text":"[ ℹ ]","color":"gray","clickEvent":{"action":"run_command","value":"/trigger mpSleep set 4"},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to preview ","color":"gray"},"Display Mode: Boss Bar",{"text":".\nThe boss bar preview's color may not be accurate.","color":"gray"}]}}," Display Mode: Boss Bar"]
			execute if score @s mpSleep.config matches 2 run tellraw @s ["",{"text":"[ ✔ ]","color":"green","clickEvent":{"action":"run_command","value":"/trigger mpSleep set 7"},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to disable ","color":"red"},"Display Mode: Action Bar",{"text":".","color":"red"}]}}," ",{"text":"[ ℹ ]","color":"gray","clickEvent":{"action":"run_command","value":"/trigger mpSleep set 5"},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to preview ","color":"gray"},"Display Mode: Action Bar",{"text":".","color":"gray"}]}}," Display Mode: Action Bar"]
			execute unless score @s mpSleep.config matches 2 run tellraw @s ["",{"text":"[ ❌ ]","color":"red","clickEvent":{"action":"run_command","value":"/trigger mpSleep set 9"},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to enable ","color":"green"},"Display Mode: Action Bar",{"text":".","color":"green"}]}}," ",{"text":"[ ℹ ]","color":"gray","clickEvent":{"action":"run_command","value":"/trigger mpSleep set 5"},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to preview ","color":"gray"},"Display Mode: Action Bar",{"text":".","color":"gray"}]}}," Display Mode: Action Bar"]
			execute if score @s mpSleep.config matches 3 run tellraw @s ["",{"text":"[ ✔ ]","color":"green","clickEvent":{"action":"run_command","value":"/trigger mpSleep set 7"},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to disable ","color":"red"},"Display Mode: Chat",{"text":".","color":"red"}]}}," ",{"text":"[ ℹ ]","color":"gray","clickEvent":{"action":"run_command","value":"/trigger mpSleep set 6"},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to preview ","color":"gray"},"Display Mode: Chat",{"text":".","color":"gray"}]}}," Display Mode: Chat"]
			execute unless score @s mpSleep.config matches 3 run tellraw @s ["",{"text":"[ ❌ ]","color":"red","clickEvent":{"action":"run_command","value":"/trigger mpSleep set 10"},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to enable ","color":"green"},"Display Mode: Chat",{"text":".","color":"green"}]}}," ",{"text":"[ ℹ ]","color":"gray","clickEvent":{"action":"run_command","value":"/trigger mpSleep set 6"},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to preview ","color":"gray"},"Display Mode: Chat",{"text":".","color":"gray"}]}}," Display Mode: Chat"]
			tellraw @a {"text":"                                                                                ","color":"dark_gray","strikethrough":true}
		}
...
function config {
	...
	tellraw @a {"text":"                                                                                ","color":"dark_gray","strikethrough":true}
	execute if score #display mpSleep.config matches 0 run tellraw @s ["",{"text":"[ ✔ ]","color":"green"}," Default Display Mode: Hidden"]
	execute unless score #display mpSleep.config matches 0 run tellraw @s ["",{"text":"[ ❌ ]","color":"red","clickEvent":{"action":"run_command","value":"/function multiplayer_sleep:config/enable_default_display_mode_hidden"},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to enable ","color":"green"},"Default Display Mode: Hidden",{"text":".","color":"green"}]}}," Default Display Mode: Hidden"]
	execute if score #display mpSleep.config matches 1 run tellraw @s ["",{"text":"[ ✔ ]","color":"green","clickEvent":{"action":"run_command","value":"/function multiplayer_sleep:config/enable_default_display_mode_hidden"},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to disable ","color":"red"},"Default Display Mode: Boss Bar",{"text":".","color":"red"},{"text":"\nDefault","color":"dark_gray"}]}}," ",{"text":"[ ℹ ]","color":"gray","clickEvent":{"action":"run_command","value":"/trigger mpSleep set 4"},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to preview ","color":"gray"},"Default Display Mode: Boss Bar",{"text":".\nThe boss bar preview's color may not be accurate.","color":"gray"}]}}," Default Display Mode: Boss Bar"]
	execute unless score #display mpSleep.config matches 1 run tellraw @s ["",{"text":"[ ❌ ]","color":"red","clickEvent":{"action":"run_command","value":"/function multiplayer_sleep:config/enable_default_display_mode_boss_bar"},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to enable ","color":"green"},"Default Display Mode: Boss Bar",{"text":".","color":"green"},{"text":"\nDefault","color":"dark_gray"}]}}," ",{"text":"[ ℹ ]","color":"gray","clickEvent":{"action":"run_command","value":"/trigger mpSleep set 4"},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to preview ","color":"gray"},"Default Display Mode: Boss Bar",{"text":".\nThe boss bar preview's color may not be accurate.","color":"gray"}]}}," Default Display Mode: Boss Bar"]
	execute if score #display mpSleep.config matches 2 run tellraw @s ["",{"text":"[ ✔ ]","color":"green","clickEvent":{"action":"run_command","value":"/function multiplayer_sleep:config/enable_default_display_mode_hidden"},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to disable ","color":"red"},"Default Display Mode: Action Bar",{"text":".","color":"red"}]}}," ",{"text":"[ ℹ ]","color":"gray","clickEvent":{"action":"run_command","value":"/trigger mpSleep set 5"},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to preview ","color":"gray"},"Default Display Mode: Action Bar",{"text":".","color":"gray"}]}}," Default Display Mode: Action Bar"]
	execute unless score #display mpSleep.config matches 2 run tellraw @s ["",{"text":"[ ❌ ]","color":"red","clickEvent":{"action":"run_command","value":"/function multiplayer_sleep:config/enable_default_display_mode_action_bar"},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to enable ","color":"green"},"Default Display Mode: Action Bar",{"text":".","color":"green"}]}}," ",{"text":"[ ℹ ]","color":"gray","clickEvent":{"action":"run_command","value":"/trigger mpSleep set 5"},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to preview ","color":"gray"},"Default Display Mode: Action Bar",{"text":".","color":"gray"}]}}," Default Display Mode: Action Bar"]
	execute if score #display mpSleep.config matches 3 run tellraw @s ["",{"text":"[ ✔ ]","color":"green","clickEvent":{"action":"run_command","value":"/function multiplayer_sleep:config/enable_default_display_mode_hidden"},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to disable ","color":"red"},"Default Display Mode: Chat",{"text":".","color":"red"}]}}," ",{"text":"[ ℹ ]","color":"gray","clickEvent":{"action":"run_command","value":"/trigger mpSleep set 6"},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to preview ","color":"gray"},"Default Display Mode: Chat",{"text":".","color":"gray"}]}}," Default Display Mode: Chat"]
	execute unless score #display mpSleep.config matches 3 run tellraw @s ["",{"text":"[ ❌ ]","color":"red","clickEvent":{"action":"run_command","value":"/function multiplayer_sleep:config/enable_default_display_mode_chat"},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to enable ","color":"green"},"Default Display Mode: Chat",{"text":".","color":"green"}]}}," ",{"text":"[ ℹ ]","color":"gray","clickEvent":{"action":"run_command","value":"/trigger mpSleep set 6"},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to preview ","color":"gray"},"Default Display Mode: Chat",{"text":".","color":"gray"}]}}," Default Display Mode: Chat"]
	execute if score #immediateChat mpSleep.config matches 1 run tellraw @s ["",{"text":"[ ✔ ]","color":"green","clickEvent":{"action":"run_command","value":"/function multiplayer_sleep:config/disable_immediate_chat"},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to disable ","color":"red"},"Immediate Chat Display",{"text":".","color":"red"},{"text":"\nWhen enabled, this sends Chat Display Mode messages at the time the player enters the bed rather than after 5 seconds of sleeping.","color":"gray"}]}}," Immediate Chat Display"]
