function load {
	execute unless entity a093751a-2c77-4658-9d5f-62ab4494bdaf positioned 16562064 1000 -22242912 run {
		name summon_marker
		forceload add ~ ~
		summon minecraft:armor_stand ~ ~ ~ {Marker:1b,NoGravity:1b,Invulnerable:1b,Invisible:1b,UUIDMost:-6876023450789001640L,UUIDLeast:-7106853199237825105L}
	}
}
function uninstall {
...
clock 1s {
	...
	execute as @e[type=minecraft:item] at @s if block ~ ~ ~ minecraft:cauldron unless block ~ ~ ~ minecraft:cauldron[level=0] run {
		...
		execute as a093751a-2c77-4658-9d5f-62ab4494bdaf if predicate cauldron_concrete:concrete_powder as @e[type=minecraft:item,tag=cauCon.subject] run {
			name harden
