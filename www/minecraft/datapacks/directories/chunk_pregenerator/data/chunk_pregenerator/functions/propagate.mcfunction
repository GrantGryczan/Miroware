...
execute as @e[type=minecraft:marker,tag=chunkPre.edge,limit=256] run function chunk_pregenerator:check_edge_marker
execute as @e[type=minecraft:marker,tag=chunkPre.notEdge,limit=256] run function chunk_pregenerator:check_not_edge_marker
