...
function try_to_try_to_try_to_go_home {
...
function try_to_try_to_go_home {
...
function try_to_reset_home_name {
...
function try_to_go_home {
	function homes:rotate/homes
	execute if score #remaining homes.dummy matches 0 run tellraw @s [{"text":"Home ","color":"red"},{"score":{"name":"#home","objective":"homes.dummy"},"color":"red"},{"text":" not found.","color":"red"}]
	execute unless score #remaining homes.dummy matches 0 run function homes:go_home
}
function try_to_add_home {
	execute if score #homes homes.dummy < #limit homes.config run function homes:add_home
...
namespace rotate {
	function players {
		...
		execute if score #remaining homes.dummy matches 0 run function homes:add_player
	}
	function player {
...
function check_dimension_marker {
	execute store result score #id homes.dummy run data get entity @s Item.tag.homesData.id
