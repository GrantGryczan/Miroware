...
this.value += html`
		<link rel="stylesheet" href="/users/{user}/garden/style.css?cb=2">`;
			...
			<div id="panels">
				<div class="panel side left">
					<div class="pane${isMe ? "" : " hidden"}">
						...
						<a id="pricing-link" href="/pricing" target="_blank" rel="noreferrer noopener">
...
this.value += html`
		...
		<script src="/users/{user}/garden/script.js?cb=13"></script>`;
