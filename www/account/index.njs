...
this.value += html`
				<form id="form">
					...
					<p class="mdc-text-field-helper-text">
						A verification email has been sent to <b>$${this.user.unverified || this.user.email}</b>. Click <a id="verifyEmail" href="javascript:;">here</a> to resend${this.user.verified ? html` or click <a id="cancelVerify" href="javascript:;">here</a> to cancel` : ""}.
					</p>` : html`<br>`) + html`
