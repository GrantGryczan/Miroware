...
this.value += html`
				<form id="form">
					...
					<p class="mdc-text-field-helper-text">
						A verification email has been sent to <b id="unverified">$${this.user.unverified}</b>. Click <a id="resendVerify" href="javascript:;">here</a> to resend or click <a id="cancelVerify" href="javascript:;">here</a> to cancel. Be sure to check your spam!
					</p>` : html`<br>`) + html`
					...
					<button id="manageConnections" class="mdc-button mdc-button--unelevated mdc-button--dense marginedMore">Manage Sign-In Methods</button>
					<a href="/billing" class="mdc-button mdc-button--unelevated mdc-button--dense marginedMore">Billing</button><br>
					<div class="mdc-text-field">
