				...
				<form id="form" autocomplete="off">${(this.user ? html`
					...
					<div id="url">
						<span id="sub"${this.req.query.sub ? "" : ' class="hidden"'}>
							...
							<input name="val" class="mdc-text-field__input" type="text" value="${this.req.query.val || ""}" maxlength="255" spellcheck="false"${!this.req.query.val || this.req.query.urls ? " autofocus" : ""}>
							<div class="mdc-line-ripple"></div>
						</div>
					</div>
					<div id="flags">
